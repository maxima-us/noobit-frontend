<template>
  <v-container fluid>
    ...
    <v-row dense>
      ...
      <v-col cols='7'>
        <OhlcChart style="border-radius: 0px"></OhlcChart>
          ...
          <v-col cols=7>
            ...
            >
              <template v-slot:default>
                <tbody>
                  <tr v-for="ask in marketDataSnapshotOrderbookAsks" :key="ask.price">
            ...
            >
              <template v-slot:default>
                <tbody>
                  <tr v-for="bid in marketDataSnapshotOrderbookBids" :key="bid.price">
          ...
          <v-col cols=5>
            ...
            >
              <template v-slot:default>
                ...
                <tbody>
                  <tr v-for="trade in marketDataSnapshotTrade" :key="trade.price">
...
import OhlcChart from '@/components/content/OhlcChart.vue'
...
export default {
  ...
  methods: {
    ...
    updatebackend () {
      this.$store.commit('setMarketDataSnapshotOrderbookAsks', [])
      this.$store.commit('setMarketDataSnapshotOrderbookBids', [])
      this.$store.commit('setMarketDataSnapshotTrade', [])
    ...
    updateCurrent () {
      ...
      var self = this
      var url = 'http://localhost:8000/config/update/requested/markets'
      axios.post(url, {
